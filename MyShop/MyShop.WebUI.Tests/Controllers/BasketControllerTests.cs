...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "mariuslarsen90@hotmail.com", ZipCode = "6847" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("mariuslarsen90@hotmail.com", "Forms"), null);
